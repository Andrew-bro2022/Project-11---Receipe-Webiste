# Note:
This is a mini Frontend React Web application with Node.js for searching receipe via Spoonacular API. If you encounter a 402 error or no data shows after search, please inform me (andyzheng.ca@gmail.com) so I can provide an updated Spoonacular API key. The Spoonacular API has a limited number of requests.
