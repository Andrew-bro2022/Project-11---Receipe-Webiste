...
//   const handleSearch = async () => {
//     // if (!query && !cuisine) {
//     //   alert("Please enter a search term or select a cuisine!"); // Alert if user tries to search without input
//     //   return;
//     // }
...
//   return (
//     <Container>
//       <h1 className="text-center my-4">Recipe Search</h1>
...
//         {recipes.length > 0 ? (
//           recipes.map((recipe) => (
//             <Col xs={12} md={4} lg={3} key={recipe.id} className="mb-4">
//               <RecipeCard recipe={recipe} />
//             </Col>
//           ))
//         ) : (
//           <p className="text-center">No recipes found. Try a different search term or cuisine.</p>
//         )}
//       </Row>
...
//       {/* Search input for entering recipe name */}
//       <input
//         type="text"
//         placeholder="Search for a recipe..."
//         value={query}
...
//           ))
//         ) : (
//           <p>No recipes found. Try a different search term or cuisine.</p>
//         )}
//       </div>
